...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.2/Practitioner-3240.html");
  else if (id == "3020")
    Response.Redirect("https://hl7chile.cl/fhir/ig/clcore/1.8.2/Practitioner-3020.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /clcore/1.8.2/crpractitioner.asp) .
</body>
</html>
