...
La operación se desarrolla basada en un **HTTP GET** o **HTTP POSY** del *Consumidor* al *Gestor* usando la operacion **FHIR** [$ihe-pix](OperationDefinition-MPI.PIXm.pix.html)
<br>
