...
* codes from system CSNivelEducacionalDesc
...
* codes from system CScalificacionPrevisional
...
* #01 "Nivel Educacional"
* #02 "Nivel Instruccion"
* #03 "Situacion Discapacidad"
* #04 "Ocupación"
...
* codes from system CSGrupoMarcas
